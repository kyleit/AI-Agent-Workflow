...
role: "Update CHANGELOG.md with issues, fixes, and release tags"
description: "AIWF Agent representing role changelog-manager."
capabilities:
  - "backend"
specializations:
  - "Changelog"
...
## Role
Update CHANGELOG.md with issues, fixes, and release tags
