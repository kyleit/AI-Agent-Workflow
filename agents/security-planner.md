...
role: "Identify security constraints and policy needs"
description: "AIWF Agent representing role security-planner."
capabilities:
  - "planning"
  - "brainstorming"
specializations:
...
## Role
Identify security constraints and policy needs
