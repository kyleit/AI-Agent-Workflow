<!-- File path: docs/implementation-governance/IMP-GOV-015_coding_standards.md -->

# IMP-GOV-015: Coding Standards

## Quy chuẩn Triển khai
Tài liệu này thiết lập các ràng buộc kỹ thuật đối với quá trình phát triển mã nguồn dự án.

## 1. Mục tiêu
Quy định chi tiết về Tiêu chuẩn viết code sạch, nhất quán đặt tên biến để đảm bảo tính an toàn, bảo mật và khả năng phục hồi.
