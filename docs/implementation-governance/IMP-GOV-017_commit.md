<!-- File path: docs/implementation-governance/IMP-GOV-017_commit.md -->

# IMP-GOV-017: Commit Strategy

## Quy chuẩn Triển khai
Tài liệu này thiết lập các ràng buộc kỹ thuật đối với quá trình phát triển mã nguồn dự án.

## 1. Mục tiêu
Quy định chi tiết về Quy chuẩn thông điệp và commit mã nguồn Git để đảm bảo tính an toàn, bảo mật và khả năng phục hồi.
