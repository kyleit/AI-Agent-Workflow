<!-- File path: docs/implementation-governance/IMP-GOV-002_workflow.md -->

# IMP-GOV-002: Implementation Workflow

## Quy chuẩn Triển khai
Tài liệu này thiết lập các ràng buộc kỹ thuật đối với quá trình phát triển mã nguồn dự án.

## 1. Mục tiêu
Quy định chi tiết về Quy trình triển khai mã nguồn chi tiết từ Task đến Commit để đảm bảo tính an toàn, bảo mật và khả năng phục hồi.
