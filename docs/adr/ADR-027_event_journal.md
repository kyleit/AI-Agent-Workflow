<!-- File path: docs/adr/ADR-027_event_journal.md -->

# ADR-027: Event Journal
...
## Context
Xây dựng nền tảng thiết kế quản trị cho Event Journal phục vụ kiến trúc AIWF OS. Đây là một hợp đồng kiến trúc cốt lõi quy định ranh giới cho các Blueprint và Implementation.

## Decision
Đồng ý cấu trúc hóa giao thức và các đặc tả thiết kế của Event Journal theo mô hình modular, bảo mật và tương thích ngược.
