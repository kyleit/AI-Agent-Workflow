<!-- File path: docs/adr/ADR-021_agent_contract.md -->

# ADR-021: Agent Contract
...
## Context
Xây dựng nền tảng thiết kế quản trị cho Agent Contract phục vụ kiến trúc AIWF OS. Đây là một hợp đồng kiến trúc cốt lõi quy định ranh giới cho các Blueprint và Implementation.

## Decision
Đồng ý cấu trúc hóa giao thức và các đặc tả thiết kế của Agent Contract theo mô hình modular, bảo mật và tương thích ngược.
