<!-- File path: docs/adr/ADR-023_agent_capability_model.md -->

# ADR-023: Agent Capability Model
...
## Context
Xây dựng nền tảng thiết kế quản trị cho Agent Capability Model phục vụ kiến trúc AIWF OS. Đây là một hợp đồng kiến trúc cốt lõi quy định ranh giới cho các Blueprint và Implementation.

## Decision
Đồng ý cấu trúc hóa giao thức và các đặc tả thiết kế của Agent Capability Model theo mô hình modular, bảo mật và tương thích ngược.
