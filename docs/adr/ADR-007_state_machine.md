<!-- File path: docs/adr/ADR-007_state_machine.md -->

# ADR-007: State Machine
...
## Context
Xây dựng nền tảng thiết kế quản trị cho State Machine phục vụ kiến trúc AIWF OS. Đây là một hợp đồng kiến trúc cốt lõi quy định ranh giới cho các Blueprint và Implementation.

## Decision
Đồng ý cấu trúc hóa giao thức và các đặc tả thiết kế của State Machine theo mô hình modular, bảo mật và tương thích ngược.
