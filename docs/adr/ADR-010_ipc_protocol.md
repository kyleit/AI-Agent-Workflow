<!-- File path: docs/adr/ADR-010_ipc_protocol.md -->

# ADR-010: IPC Protocol
...
## Context
Xây dựng nền tảng thiết kế quản trị cho IPC Protocol phục vụ kiến trúc AIWF OS. Đây là một hợp đồng kiến trúc cốt lõi quy định ranh giới cho các Blueprint và Implementation.

## Decision
Đồng ý cấu trúc hóa giao thức và các đặc tả thiết kế của IPC Protocol theo mô hình modular, bảo mật và tương thích ngược.
