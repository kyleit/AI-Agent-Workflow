<!-- File path: docs/adr/ADR-001_runtime_principles.md -->

# ADR-001: Runtime Principles
...
## Context
Xây dựng nền tảng thiết kế quản trị cho Runtime Principles phục vụ kiến trúc AIWF OS. Đây là một hợp đồng kiến trúc cốt lõi quy định ranh giới cho các Blueprint và Implementation.

## Decision
Đồng ý cấu trúc hóa giao thức và các đặc tả thiết kế của Runtime Principles theo mô hình modular, bảo mật và tương thích ngược.
