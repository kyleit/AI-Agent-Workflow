...
class TestProviderManager(unittest.TestCase):
    ...
    def test_sync_obsidian_readonly(self):
        ...
        res = provider_manager.sync_obsidian(project_root=self.project_dir)
        self.assertIn("docs/brainstorming/idea.md", [f.replace("\\", "/") for f in res["stats"]["skipped_readonly"]])
    ...
    def test_sync_obsidian_bidirectional_conflict(self):
        ...
        res = provider_manager.sync_obsidian(project_root=self.project_dir)
        self.assertIn("docs/brainstorming/idea.md", [f.replace("\\", "/") for f in res["stats"]["conflicts"]])
