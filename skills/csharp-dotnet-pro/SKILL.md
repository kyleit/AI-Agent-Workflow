...
- **Entry Conditions**: Eligible ONLY when the active task involves C# / .NET / Unity technology context, confirmed by repository/file evidence or explicit Owner request, and explicitly dispatched by Orchestrator.
- **Exit Behavior**: Provides specialized findings, recommendations, and code guidelines. MUST NOT auto-route the next workflow phase or self-approve gates.
