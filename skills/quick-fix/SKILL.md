...
- **Git Workflow Policy** (Section 2) - Perform branch checks and switch to `fix/FIX-XXX-slug` with confirmation.
- **Memory First Policy** (Section 3) - When retrieving codebase context.
- **RAG Policy** (Section 4) - Using RAG search hierarchy.
- **Artifact Policy** (Section 5) - For generating `docs/issues/FIX-XXX_issue_name.md` files.
...
### Step 11: Generate Quick-Fix Summary Report
...
```markdown
### 📋 Quick-Fix Self-Validation Checklist
