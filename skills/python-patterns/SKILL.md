...
- **Entry Conditions**: Eligible ONLY when the active task involves Python architecture, design patterns, or Python code refactoring, and is explicitly dispatched by Orchestrator.
- **Exit Behavior**: Provides specialized architectural findings, design patterns, and recommendations. MUST NOT auto-route the next workflow phase or self-approve gates.
