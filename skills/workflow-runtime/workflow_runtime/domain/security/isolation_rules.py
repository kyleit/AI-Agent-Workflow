...
def classify_intent(prompt: str, active_work_item_id: str | None = None) -> tuple[str, float]:
    """
...
def process_incoming_prompt(prompt: str, workspace_id: str, session_id: str, active_work_item_id: str | None = None, active_workflow_id: str | None = None, state_dir: str = ".agents/state") -> dict[str, Any]:
    """
