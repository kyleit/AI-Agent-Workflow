...
from workflow_runtime.infrastructure.events.event_logger import (
    DEBUG_FAILED, DEBUG_PASSED, FILE_LOCK_ACQUIRED, FILE_LOCK_RELEASED,
    PHASE_COMPLETED, PHASE_STARTED, RELEASE_BLOCKED, RELEASE_COMPLETED,
    RELEASE_REQUESTED, SKILL_COMPLETED, SKILL_FAILED, SKILL_STARTED,
    STATE_MIGRATED, TASK_COMPLETED, TASK_FAILED, TASK_STARTED, USAGE_UPDATED,
    VERIFY_FAILED, VERIFY_PASSED, WORKER_COMPLETED, WORKER_FAILED,
    WORKER_ORPHANED, WORKER_SPAWNED, WORKFLOW_ARTIFACT_VIOLATION,
    WORKFLOW_BLOCKED, WORKFLOW_INITIALIZED, EventLogger, read_jsonl_safe)
from workflow_runtime.infrastructure.filesystem.atomic_writer import (
    read_json_safe, write_json_atomic)
from workflow_runtime.infrastructure.session.state_path import (ensure_dirs,
                                                                get_state_file,
                                                                get_subdir)
...
class EventReducer:
    ...
    def _on_workflow_initialized(self, p: dict[str, Any]) -> None:
    ...
    def _on_skill_started(self, p: dict[str, Any]) -> None:
    ...
    def _on_skill_completed(self, p: dict[str, Any]) -> None:
    ...
    def _on_skill_failed(self, p: dict[str, Any]) -> None:
    ...
    def _on_phase_started(self, p: dict[str, Any]) -> None:
    ...
    def _on_phase_completed(self, p: dict[str, Any]) -> None:
    ...
    def _on_task_started(self, p: dict[str, Any]) -> None:
    ...
    def _on_task_completed(self, p: dict[str, Any]) -> None:
    ...
    def _on_worker_spawned(self, p: dict[str, Any]) -> None:
        runtime = self._read("runtime")
    ...
    def _on_worker_completed(self, p: dict[str, Any]) -> None:
        runtime = self._read("runtime")
        workers = runtime.setdefault("active_workers", {})
        worker_id = p.get("worker_id", "")
    ...
    def _on_worker_failed(self, p: dict[str, Any]) -> None:
        runtime = self._read("runtime")
        workers = runtime.setdefault("active_workers", {})
        worker_id = p.get("worker_id", "")
        if worker_id in workers:
    ...
    def _on_worker_orphaned(self, p: dict[str, Any]) -> None:
        runtime = self._read("runtime")
        workers = runtime.setdefault("active_workers", {})
        worker_id = p.get("worker_id", "")
        if worker_id in workers:
    ...
    def _on_file_lock_acquired(self, p: dict[str, Any]) -> None:
        runtime = self._read("runtime")
    ...
    def _on_file_lock_released(self, p: dict[str, Any]) -> None:
        runtime = self._read("runtime")
        locks = runtime.setdefault("active_locks", {})
        file_path = p.get("file_path", "")
    ...
    def _on_debug_passed(self, p: dict[str, Any]) -> None:
    ...
    def _on_debug_failed(self, p: dict[str, Any]) -> None:
        workflow = self._read("workflow")
    ...
    def _on_verify_passed(self, p: dict[str, Any]) -> None:
        workflow = self._read("workflow")
    ...
    def _on_verify_failed(self, p: dict[str, Any]) -> None:
        workflow = self._read("workflow")
    ...
    def _on_release_requested(self, p: dict[str, Any]) -> None:
        workflow = self._read("workflow")
    ...
    def _on_release_blocked(self, p: dict[str, Any]) -> None:
        workflow = self._read("workflow")
    ...
    def _on_release_completed(self, p: dict[str, Any]) -> None:
        workflow = self._read("workflow")
    ...
    def _on_usage_updated(self, p: dict[str, Any]) -> None:
    ...
    def _on_workflow_blocked(self, p: dict[str, Any]) -> None:
