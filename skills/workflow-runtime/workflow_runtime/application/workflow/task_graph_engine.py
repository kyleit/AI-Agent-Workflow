...
class TaskGraphEngine:
    ...
    def has_cycle(self) -> bool:
        ...
        """
        in_deg: defaultdict[str, int] = self.in_degree.copy()
        queue: deque[str] = deque([n for n in self.nodes if in_deg[n] == 0])
        visited_count = 0
    ...
    def get_schedule(self) -> list[str]:
        ...
        zero_in_degree: list[str] = [n for n in self.nodes if in_deg[n] == 0]
