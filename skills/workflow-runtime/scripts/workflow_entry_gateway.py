...
class WorkflowEntryGateway:
    ...
    def handle_request(self, request_text: str, source: str = None, session_id: str = None) -> dict:
        ...
        if not request_text or not request_text.strip():
            raise ValueError("request_text cannot be empty or whitespace only")
        ...
        from state_store import register_work_item
        register_work_item(workflow_id, workflow_type=intent)
