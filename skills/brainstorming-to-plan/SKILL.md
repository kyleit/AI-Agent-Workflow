...
- **Validate Checkpoint**: Run `aiwf validate --checkpoint "exactly 3 or 2"` before taking any action. If validation fails, halt execution immediately.
- **Progress Tracking**:
  - *Start*: Run `aiwf start --skill "brainstorming-to-plan" --command "plan" --checkpoint 3 --step "Starting execution..."`
